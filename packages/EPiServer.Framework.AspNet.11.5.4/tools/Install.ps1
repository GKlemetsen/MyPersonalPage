...
if (Test-Path $webConfigPath) 
{
	...
	$frameworkUpgradePath =[System.IO.Path]::Combine($installPath, "tools\epiupdates\**\*.config")
	& $epideployPath -s $sitePath -a config -p $frameworkUpgradePath
}
# SIG # Begin signature block
# MIIXpAYJKoZIhvcNAQcCoIIXlTCCF5ECAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUw9TpamRZzZu3/HAyvs8KSaib
# h/ygghLKMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# BBSR71UWH8NcBj+gli4KVYwQ44lEhDANBgkqhkiG9w0BAQEFAASCAQB0tXk+G1Ks
# ogQ/WA+dFdwtMbDUAK2/sQRh2Qem6ZfYjWSwLEPZ2Ehiwmo40aD32u1i1kkwK2le
# qSx6xK5HfIfiPRIXBAUfaIpjFXenxkUklmtrcK9BORhj0+h3fp/u06MhuDhdTvOR
# JLQP/s+A1IgzrgYLjtDw7Wt1vkHdySp7FtA3+N3FjqxWYcxIt2RRD18yPI9IXPCh
# hHLf06n40pd8FeNqrqcYnyvnkL+/FbpgdmTTKs8dNrGbmSepuyHP51bwifccKwas
# T+vV7qlemLOYsWIK8iRFo+jqHhgaIewESIHw+nQwJcJ+EutLkfQAzUnntAtHfIbJ
# 5lNDLRdFpyN7oYICCzCCAgcGCSqGSIb3DQEJBjGCAfgwggH0AgEBMHIwXjELMAkG
...
# FA0i89WAUSRaZMeS5OqDu0FdC9xIMA0GCSqGSIb3DQEBAQUABIIBABaIwFRl4+PP
# I0SObRncMcVsE3PZyGAcpQW35I2m87RKgSCICo2u7/+h3HCgdDd1uK3XtnhZqZC4
# zV4ejUdIgbO99sGMajCpsfJvt1RKnW8Z60DmbevTXEG/LbCayvYgRBzqOT1WVWC+
# WJTpvWVM3NxO9BeOANqfMMiGJfZnzdQxbLFu/wCwped/Z9V2l7M6qMAOm3TQGEWP
# aYxZBbtMOy/xPG0Kwsbgw/jctzmAuAY00/3PTko8BSxWFdzfNAJtiaXAcoM+oEgN
# Iwbaioe+qT4Sa8n4S8UUwf6nbZdXv5DFBArbZW77NxWRPMcQFq+MfP4kbi9JWsB/
# Gj3syiozaRk=
