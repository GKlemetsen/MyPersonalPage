...
GO
PRINT N'Creating [dbo].[tblApprovalDefinitionReviewer]...';
...
GO
PRINT N'Creating [dbo].[tblApprovalDefinitionReviewer].[IDX_tblApprovalDefinitionReviewer_Username]...';
...
GO
PRINT N'Creating [dbo].[tblApprovalDefinitionReviewer].[IDX_tblApprovalDefinitionReviewer_fkApprovalDefinitionVersionID]...';
...
GO
PRINT N'Creating [dbo].[tblApprovalDefinition].[IDX_tblApprovalDefinition_ApprovalDefinitionKey]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[tblApprovalDefinitionVersion]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[tblApprovalDefinitionStep]...';


GO
ALTER TABLE [dbo].[tblApprovalDefinitionStep]
    ADD DEFAULT (1) FOR [ReviewersNeeded];


GO
PRINT N'Creating unnamed constraint on [dbo].[tblApprovalDefinitionReviewer]...';
...
GO
PRINT N'Creating [dbo].[DF__tblScheduledItem__IsStoppable]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[tblScheduledItem]...';
...
GO
PRINT N'Creating [dbo].[FK_tblApprovalStepDecision_tblApproval]...';
...
GO
PRINT N'Creating [dbo].[FK_tblApprovalDefinitionVersion_tblApprovalDefinition]...';
...
GO
PRINT N'Creating [dbo].[FK_tblApprovalDefinitionStep_tblApprovalDefinitionVersion]...';
...
GO
PRINT N'Creating [dbo].[FK_tblApprovalDefinitionReviewer_tblApprovalDefinitionStep]...';
...
GO
PRINT N'Creating [dbo].[FK_tblApprovalDefinitionReviewer_tblApprovalDefinitionVersion]...';
...
GO
PRINT N'Creating [dbo].[FK_tblApprovalDefinitionReviewer_tblLanguageBranch]...';
...
GO
PRINT N'Creating [dbo].[FK_tblApprovalDefinition_tblApprovalDefinitionVersion]...';
...
GO
PRINT N'Creating [dbo].[FK_tblApproval_tblApprovalDefinitionVersion]...';
...
GO
PRINT N'Creating [dbo].[FK_tblApproval_tblLanguageBranch]...';
